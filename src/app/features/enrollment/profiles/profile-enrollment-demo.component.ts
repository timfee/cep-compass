    ...
    <div class="profile-enrollment-container">
      <mat-card>
        <mat-card-header>
          ...
          <mat-card-subtitle>Help users sign in to Chrome with managed accounts</mat-card-subtitle>
        </mat-card-header>
        ...
        <mat-card-content>
          ...
          <section class="stats-section">
            ...
            <div class="sync-info">
              ...
              <span>Last synced: {{ mockStats().lastSyncTime | date:'short' }}</span>
              <button mat-icon-button (click)="refreshStats()" matTooltip="Refresh" [disabled]="isLoading()">
          ...
          <section class="email-section">
            ...
            <p>Draft an email to educate users about signing in to Chrome with their work accounts.</p>
            
            <div class="email-actions">
              <button mat-raised-button color="primary" (click)="draftSingleEmail()">
            ...
            <mat-expansion-panel class="instructions-panel">
              ...
              <mat-list>
                ...
                <mat-list-item>
                  ...
                  <span matListItemTitle>Click "Turn on sync" or "Sign in to Chrome"</span>
                </mat-list-item>
                <mat-list-item>
          ...
          <section class="resources-section">
            ...
            <a mat-stroked-button href="https://support.google.com/chrome/a/answer/7394216" target="_blank">
      ...
      <mat-card class="demo-note">
        <mat-card-content>
          <mat-icon>info</mat-icon>
          <strong>Demo Mode:</strong> This is a demonstration of the Profile Enrollment component. 
          In a real environment, this would integrate with Google Workspace Directory API and 
...
export class ProfileEnrollmentDemoComponent {
   ...
   */
  draftBulkEmail(): void {
    alert('Demo: Would open email composer for bulk email to all active users (1189 recipients)');
  }
